            ...
            @forelse ($authors as $author)
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteConfirmationModal{{ $author->id }}">
                ...
                <div class="modal fade" id="deleteConfirmationModal{{ $author->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteConfirmationModalLabel{{ $author->id }}" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="deleteConfirmationModalLabel{{ $author->id }}">Confirm Deletion</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                Are you sure you want to delete the author with name "{{ $author->name }}"?
                            </div>
