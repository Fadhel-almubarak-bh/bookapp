        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-white" style="background-color: #343a40; color: white;">
                    ...
                    <h3 class="text-center w-100 mb-0">View Category</h3>
                </div>
                <div class="card-body">
                    ...
                    <h4 class="mt-4">Books by {{ $category->name }}</h4>
                    @if($books->isEmpty())
                    ...
                    <div class="card-body text-right text-center">
                        <a href="{{ route('categories.edit', $category->id) }}" class="btn btn-warning m-1"><i class="fas fa-edit"></i> Edit
                        </a>
