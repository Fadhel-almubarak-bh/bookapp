        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-white" style="background-color: #343a40; color: white;">
                    ...
                    <h3 class="text-center w-100 mb-0">View Location</h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="name">Location Name:</label>
                        <input type="text" id="name" class="form-control" value="{{ $location->name }}" readonly>
                    </div>

                    <h4 class="mt-4">Books by {{ $location->name }}</h4>
                    @if($books->isEmpty())
                    ...
                    <div class="card-body text-right text-center">
                        <a href="{{ route('locations.edit', $location->id) }}" class="btn btn-warning m-1"><i class="fas fa-edit"></i> Edit
                        </a>
...
<div class="modal fade" id="deleteConfirmationModal" tabindex="-1" role="dialog" aria-labelledby="deleteConfirmationModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                <form id="deleteForm" action="{{ route('locations.destroy', $location->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-danger">Delete</button>
                </form>
